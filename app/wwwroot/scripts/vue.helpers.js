            ...
            directives['move-when-mounted'] = {
                mounted: function (element, binding) {
                    ...
                    if (previous) {
                        ...
                        element.style.transform = "translate(".concat(previous.left - current.left, "px,").concat(previous.top - current.top, "px) ").concat(style.transform);
...
//# sourceMappingURL=vue.helpers.js.map